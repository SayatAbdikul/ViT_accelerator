...
from .passes import run_passes, default_pipeline_w8a32
...
class Compiler:
    ...
    def __init__(self, cfg: Optional[ModelConfig] = None,
                 mode: Literal["w8a8", "w8a32"] = "w8a8"):
        if mode not in ("w8a8", "w8a32"):
            raise ValueError(f"mode must be 'w8a8' or 'w8a32', got {mode!r}")
