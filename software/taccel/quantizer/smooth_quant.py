...
Activation-quant-only — dormant on the W8A32 and W8A16 paths (per-channel
activation outliers do not need to be smoothed when activations stay in
FP32 or FP16). Retained for the W8A8 production pipeline.
"""
